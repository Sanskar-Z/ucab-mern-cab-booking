...
export default function RideTracking() {
  ...
  async function handleCancel() {
    try {
      const res = await API.post(`/rides/${activeRide._id}/cancel`)
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <section className="lg:col-span-5 xl:col-span-4 space-y-6">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
              ...
              <div className="p-6 flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold">{activeRide?.driver ? activeRide?.driver?.name : "Driver Not Assigned"}</h3>
                  <p className="text-sm text-slate-500">
                    {activeRide?.driver ? activeRide?.driver?.vehicleDetails?.vehicleType : ""}
                    {" "}
              ...
              <div className="p-6 bg-slate-50 border-t xborder-slate-100">
                <button
          ...
          <section className="lg:col-span-7 xl:col-span-8 lg:min-h-[700px]">
            {/* <div className="h-full bg-slate-200 rounded-2xl flex flex-col items-center justify-center relative overflow-hidden group border border-slate-200 shadow-inner"> */}
